      ...
      <ul class="left">
        <li>
          <h1 class="logo-wrapper">
            <a class="brand-logo darken-1" href="{{url('/superadmin/dashboard')}}">
  ...
  <nav class="white hide-on-med-and-down" id="horizontal-nav">
    <div class="nav-wrapper">
      <ul class="left hide-on-med-and-down" id="ul-horizontal-nav" data-menu="menu-navigation">
        ...
        @if(!empty($SuperadminmenuData[1]) && isset($SuperadminmenuData[1]))
          @foreach ($SuperadminmenuData[1]->menu as $menu)
            @php
            $custom_classes="";
            if(isset($menu->class))
            {
          ...
          <li {{(request()->is($menu->url)) ? 'class=active':''}}>
            <a class="@if(isset($menu->submenu)){{'dropdown-menu'}} @endif" href="superadmin/{{$menu->url}}"
