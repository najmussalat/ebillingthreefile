  ...
  <div class="col s12 m12 l12">
    ...
    <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
            <h4 class="card-title">Find Inactive Customer</h4>
         
            {!! Form::open(array('url' => 'admin/inactivecustomerfind','method'=>'GET' )) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col m3 s12">
                                {!! Form::date('to',  null, ['id' => 'to', 'placeholder' => 'Select Date']) !!}
                                {!! Form::label('to', 'To ') !!}
                            </div>
                             <div class="input-field col m3 s12">
                                {!! Form::date('from',  null, ['id' => 'to', 'placeholder' => 'Select From']) !!}
