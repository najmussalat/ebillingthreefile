...
$(document).ready(function () {
  ...
  $.ajax({
          ...
          $('#adress').append('<span>' + data.result.district.district + ',' + data.result.thana.thana + ',' + data.result.area.areaname + ',' + data.result.customermobile + '</span>');
                        ...
                        $('#dt').append('<tr><>' + newvalue.updated_at + '</td><td>Collection By </br>' + newvalue.admin['name'] + '</td><td>' + newvalue.paid + '</td><td><button id="Deletepay" paidval="'+newvalue.paid+'" rid="'+newvalue.id+'"><i class="material-icons">cancel</i></button></td></tr>'
                        );
