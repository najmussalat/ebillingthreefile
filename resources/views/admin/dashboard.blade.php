...
{{-- <div class="section">
              ...
              <div class="padding-4">
                 <div class="row">
                    ...
                    <div class="col s5 m5 right-align">
                       <h5 class="mb-0 white-text">{{$admin->count('id')}}</h5>
                       <p class="no-margin">Admin</p>
                       <p>{{Auth::id()}}</p>
                    </div>
                 </div>
              </div>
 ...
 <div id="card-stats" class="pt-0">
  ...
  <!--end container-->
  @if(count($bloginfo)>0)
<marquee behavior="scroll" scrollamount="5" direction="left" align ="center"> 
    @foreach ($bloginfo as $binfo)
 <a href="https://www.homeobari.com/info/{{$binfo->slug}}" target='_blank'> {{$binfo->title}} <i class="material-icons">call_missed_outgoing</i> </a> &nbsp; &nbsp; &nbsp;
 ...
 <div id="ProfileModal" class="modal" style="z-index: 1003; display: none; opacity: 0; top: 4%; transform: scaleX(0.8) scaleY(0.8);">
  <div class="modal-content">
    <p class="modal-header right modal-close">
      Skip  <span class="right"><i class="material-icons right-align">clear</i></span>
  </p>
   <p class="alert"> Your Profile Is Not complete please full fill your profile</p>
   <hr/>
   <a class="active-link" href="{{url('admin/profile')}}">
    Update Your Profile
  </a>
