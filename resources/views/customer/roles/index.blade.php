            ...
            <div class="card-content">
              <div class="input-field col s12 m9">
                ...
                <div class="col s12 m3 l3 input-field">
                    ...
                    <a href="{{url('admin/createaccountrole')}}" class="waves-effect waves-light  btn "><i class="material-icons right">gps_fixed</i> Create Role</a>
                </div>
                              ...
                              @foreach ($roles as $role)
                                ...
                                <tr>
                                  <td>{{++$i}}</td>
                                   ...
                                   <td>
                                    <a href="{{url('admin/editaccountrole/'.$role->id) }}" class="btn-floating mb-1 waves-effect waves-light">
                                      <i class="material-icons">edit</i>
                                    </a>
                                  </td>
                                   
                                      <td> {!! Form::open(['method' => 'DELETE','url' => ['admin/deleteaccountrole', $role->id],'onsubmit' => 'return confirm("are you sure ?")']) !!}
