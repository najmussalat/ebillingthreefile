                                  ...
                                  <div class="card-content">
                                    <div class="input-field col s12 m9">
                                      ...
                                      <div class="col s12 m3 l3 input-field">
                                          ...
                                          <a href="{{url('superadmin/createdisemedicinelist')}}" class="waves-effect waves-light  btn "><i class="material-icons right">gps_fixed</i> Create New</a>
                                      </div>
                                                  ...
                                                  <tbody>
                                                    ...
                                                    @foreach ($medicinefordisease as $medicine)
                                                       <tr>
                                                         ...
                                                         <td>
                                                          <a href="{{url('superadmin/editdisemedicinelist/'.$medicine->id) }}" class="btn-floating mb-1 waves-effect waves-light">
                                                            <i class="material-icons">edit</i>
                                                          </a>
                                                        </td>
                                                         
                                                            <td> {!! Form::open(['method' => 'DELETE','url' => ['superadmin/deletedisemedicinelist/'. $medicine->id],'onsubmit' => 'return confirm("are you sure ?")']) !!}
...
function timer(){
  ...
  $.ajax({
          type: "post",
          url:url+'/superadmin/searchdisemedicinelist',
          data: {
              id:$search
