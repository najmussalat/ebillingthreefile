                                  ...
                                  <div class="card-content">
                                    <div class="input-field col s12 m9">
                                      ...
                                      <div class="col s12 m3 l3 input-field">
                                          ...
                                          <a href="{{url('superadmin/createdistrict')}}" class="waves-effect waves-light  btn "><i class="material-icons right">gps_fixed</i> Create New District</a>
                                      </div>
                                          ...
                                          <div class="col s12">
                                              <table id="page-length-option" class="display responsive-table">
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <td>{{@$tha->division->division}} </td>
                                                       <td>{{@$tha->district}}</td>
                                                    
													                           
                                                      <td><a  href="{{url('superadmin/editdistrict/'.$tha->id) }}"  class="btn-floating mb-1 waves-effect waves-green">
                                                         <i class="material-icons">edit</i>
                                                    </a> 
                                                    <td>
                                                      <td>
                                                        {!! Form::open(['method' => 'DELETE','url' => ['superadmin/deletedistrict', $tha->id],'onsubmit' => 'return confirm("are you sure ?")']) !!}
...
function timer(){
  ...
  $.ajax({
          type: "post",
          url:url+'/superadmin/searchdistrict',
          data: {
              id:$search
