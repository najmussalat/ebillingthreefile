        ...
        <div class="card">
            <div class="card-content">
                ...
                <div class="col s12 m3 l3 input-field">
                    ...
                    <a href="{{ url('superadmin/createpayment') }}" class="waves-effect waves-light  btn "><i
                            class="material-icons right">gps_fixed</i> Create New Payment</a>
                </div>
                                ...
                                @if (count($infos) > 0)
                                    @foreach ($infos as $info)
                                        <tr>
                                            ...
                                            <td>{{ $info->note }}</td>
                                            <td> <a href="{{ url('superadmin/editpayment/' . $info->id) }}"
                                                    class="invoice-action-edit">
                                                    <i class="material-icons">edit</i>
                                                </a></td>

                                            <td> {!! Form::open(['method' => 'DELETE', 'url' => ['superadmin/deletepayment', $info->id], 'onsubmit' => 'return confirm("are you sure ?")']) !!}
                                                <button type="submit"
                                                    class="btn-floating mb-1 waves-effect waves-light"> <i
