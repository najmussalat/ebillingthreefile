                                  ...
                                  <div class="card-content">
                                    <div class="input-field col s12 m9">
                                      ...
                                      <div class="col s12 m3 l3 input-field">
                                          ...
                                          <a href="{{url('superadmin/createadmin')}}" class="waves-effect waves-light  btn "><i class="material-icons right">gps_fixed</i> Create New Admin</a>
                                      </div>
                                                    ...
                                                    @foreach ($admininfo as $admin)
                                                       <tr>
                                                        <td>{{++$i}}</td>
                                                          ...
                                                          <td>{{$admin->name}}</td>
                                                          <td><img  src="{{@url('storage/app/files/shares/profileimage/thumbs/'.$admin->image)}}" class="circle z-depth-2 responsive-img avtar"></td>
                                                     ...
                                                     <td>@if($admin->status==1)
                                                         ...
                                                         <td>
                                                          <div class="invoice-action">
                                                              ...
                                                              <a  href="{{url('superadmin/editadmin/'.$admin->id) }}" class="invoice-action-edit">
                                                         ...
                                                         <td> {!! Form::open(['method' => 'DELETE','url' => ['superadmin/deleteteadmin/'.$admin->id],'onsubmit' => 'return confirm("are you sure ?")']) !!}
...
function timer(){
  ...
  $.ajax({
          type: "post",
          url:url+'/superadmin/searchadmin',
          data: {
              id:$search
