...
@section('content')
@section('title', 'Sms type Update')
<div class="col s12 m12 l12">
                               
    <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
            <h4 class="card-title"> Update SMS Type Form</h4>
            {!! Form::model($infos, array('url' =>['superadmin/updatesmstype/'.$infos->id], 'method'=>'PATCH','id'=>'theform')) !!}
