        ...
        <div class="card">
            <div class="card-content">
                ...
                <div class="col s12 m3 l3 input-field">
                    ...
                    <a href="{{ url('superadmin/createsmstype') }}" class="waves-effect waves-light  btn "><i
                        class="material-icons right">gps_fixed</i> Create New SMS</a>
                </div>
                                ...
                                @if (count($infos) > 0)
                                    @foreach ($infos as $info)
                                        <tr>
                                            ...
                                            <td>{{ $info->maskingnonmasking }}</td>
                                            <td>{{ $info->charge }}</td>
                                            <td> <a href="{{ url('superadmin/editsmstype/' . $info->id) }}"
