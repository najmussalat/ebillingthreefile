                                  ...
                                  <div class="card-content">
                                    <div class="input-field col s12 m9">
                                      ...
                                      <div class="col s12 m3 l3 input-field">
                                          ...
                                          <a href="{{url('superadmin/createcountry')}}" class="waves-effect waves-light  btn "><i class="material-icons right">gps_fixed</i> Create New</a>
                                      </div>
                                          ...
                                          <div class="col s12">
                                              <table id="page-length-option" class="display responsive-table">
                                                  ...
                                                  <tbody>
                                                    ...
                                                    @foreach ($countryinfo as $tha)
                                                       <tr>
                                                          
                                                           <td>{{++$i}}</td>
                                                    <td>{{$tha->created_at->diffForHumans()}}</td>
                                                       <td>{{$tha->countryname}}</td>
                                                     <td> <a href="{{url('superadmin/editcountry/'.$tha->id) }}" class="invoice-action-edit">
                                                                  <i class="material-icons">edit</i>
                                                              </a></td>
                                                         
                                                               <td> {!! Form::open(['method' => 'DELETE','url' => ['superadmin/deletecountry', $tha->id],'onsubmit' => 'return confirm("are you sure ?")']) !!}
