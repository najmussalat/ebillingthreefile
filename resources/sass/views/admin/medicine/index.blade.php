                                  ...
                                  <div class="card-content">
                                    <div class="input-field col s12 m9">
                                      ...
                                      <div class="col s12 m3 l3 input-field">
                                          ...
                                          <a href="{{url('admin/createmedicinelist')}}" class="waves-effect waves-light  btn "><i class="material-icons right">gps_fixed</i> Create New</a>
                                      </div>
                                                  ...
                                                  <tbody>
                                                    ...
                                                    @foreach ($medicines as $medicine)
                                                     ...
                                                     <td>@if($medicine->status==1)
                                                         ...
                                                         @endif</td>
                                                         <td>
                                                          <a href="{{url('admin/editmedicinelist/'.$medicine->id) }}" class="btn-floating mb-1 waves-effect waves-light">
                                                            <i class="material-icons">edit</i>
                                                          </a>
                                                        </td>
                                                         
                                                            <td> {!! Form::open(['method' => 'DELETE','url' => ['admin/deletemedicinelist/'.$medicine->id],'onsubmit' => 'return confirm("are you sure ?")']) !!}
