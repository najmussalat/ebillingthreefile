                                    ...
                                    <div class="row invoice-info">
                                        <div class="col m6 s12">
                                            ...
                                            <p class="mb-1">Address & phone no:
                                                {{ @$customer->customerphone }},{{ @$customer->houseno }}
                                                {{ @$customer->houseno }},
                                    ...
                                    <div class="col s12">
                                        ...
                                        <div class="row invoice-info">
                                            <div class="col m6 s12">
                                                ...
                                                <p class="mb-1">Address & phone no. {{ @$customer->customerphone }},{{ @$customer->houseno }}
                                                    {{ @$customer->houseno }},
                                                    {{ @$customer->area->areaname }}</p>
                                    ...
                                    <div class="col s12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col m6 s12">
                                                ...
                                                <p class="right">
                                                    <img src="{{ @url('storage/app/files/shares/singnaturephoto/thumbs/' . CommonFx::printsetting()->singnature) }}"> <br>
                                                    Authorized Signature
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div class="col s12">
                                ...
                                <div class="row invoice-info">
                                    <div class="col m12 s12">
                                        <div class="row">
                                            <div class="col m12 s12">
                                                <p>Issue Date: {{ date('M-d-Y', strtotime(@Carbon\Carbon::now())) }}</p>
                                            </div>
                                        </div>
                                            <div class="row">
                                            <div class="col m12 s12">
                                        ...
                                        <h6 class="customer-name" style="color: #6b6f82; font-weight: 700;">{{ @$customer->customername }}</h6>
                                       
                                       
                                        <p class="mb-1">Address & phone no.   {{ @$customer->customerphone }},{{ @$customer->houseno }}
                                            {{ @$customer->houseno }},
                                            {{ @$customer->district->district }},{{ @$customer->thana->thana }},{{ @$customer->area->areaname }}</p>
                                        <p class="mb-1">Contact Person: {{ @$customer->contactperson }}</p>
              ...
              <table class="bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <td> {{ date('M-Y', strtotime(@Carbon\Carbon::now())) }}</td>
                    <td>
<div class="row">
    <div class="col m12 s12">
        <ul>
