...
class Helper
{
    public static function applClasses()
    {
        ...
        $dataDefault = [
            ...
            'templateTitle' => '',
            'defaultLanguage'=>'en',
            'largeScreenLogo' => 'den/images/logo/favicon.ico',
            'smallScreenLogo' => 'den/images/logo/favicon.ico',
        ...
        $sidenavMainColor = [
            'vertical-modern-menu' => 'sidenav-dark',
        ...
        $navbarMainColor = [
            'vertical-modern-menu' => 'navbar-dark',
